            ...
            <div class="l-navbar" id="nav-bar">
                <nav class="nav">
                    <div> <a href="home.php" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Mandatsverwaltung</span> </a>
                        ...
                        <div class="nav_list"> <a href="costumer.php" class="nav_link active"> <i class='bx bx-user nav_icon'></i> <span class="nav_name">Kunden</span>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Fristen</th>
                                            <th scope="col">Aufgaben für den Kunden</th>
                                            <th scope="col">Verantwortliche Mitarbeiter</th>
                                            <th scope="col">Status der Arbeit</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT kundenname, fristen, arbeiten, mitarbeiter, status, note FROM costumer";
