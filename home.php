            ...
            <div class="l-navbar" id="nav-bar">
                <nav class="nav">
                    <div> <a href="home.php" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Mandatsverwaltung</span> </a>
                        <div class="nav_list"> <a href="home.php" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span> </a> 
                            <a href="customer.php" class="nav_link"> <i class='bx bx-user nav_icon'></i> <span class="nav_name">Kunden</span> </a> 
                            <a href="notes.php" class="nav_link"> <i class='bx bx-message-square-detail nav_icon'></i> <span class="nav_name">Notitzen</span> </a> 
                        ...
                        <div class="height-100 bg-light">
                            <h4>Herzlich Willkommen,  <?php echo $_SESSION['user_name']; ?></h4>
                            <table class="table table-bordered">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th width=300 scope="col">Kundenname</th>
                                            <th width=300 scope="col">Fristen</th>
                                            <th width=300 scope="col">Aufgaben für den Kunden</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT id, kundenname, fristen, arbeiten FROM costumer";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo' <td>' . $row["fristen"] . '</td>';
                                                echo' <td>' . $row["arbeiten"] . '</td>';
                                                echo'</tr>';
                                            }
                                        } else {
                                            echo "0 results";
