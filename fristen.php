...
<html>
    ...
    <body id="body-pd"> 
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                ...
                <a href="home.php" class="nav_link"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span> </a> 
                    ...
                    <div class="nav_list"> <a href="fristen.php" class="nav_link active"> <i class='bx bx-bookmark nav_icon'></i> <span class="nav_name">Fristen</span>
        ...
        <h4>Vorbereitung für Fristen</h4>
                        <br>
                        <p>Aktuell befindet sich der Bereich Fristen in der Entwicklung</p>
                        <br>
